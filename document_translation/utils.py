...
def load_translation_languages():
    ...
    language_data = [
        ...
        ("Cantonese (Traditional)", "yue"), ("Catalan", "ca"), ("Chinese (Literary)", "lzh"),
        ("Chinese Simplified", "zh-Hans"), ("Chinese Traditional", "zh-Hant"), ("Croatian", "hr"),
        ("Czech", "cs"), ("Danish", "da"), ("Dari", "prs"), ("Divehi", "dv"), ("Dutch", "nl"),
        ("English", "en"), ("Estonian", "et"), ("Faroese", "fo"), ("Fijian", "fj"),
        ("Filipino", "fil"), ("Finnish", "fi"), ("French", "fr"), ("French (Canada)", "fr-ca"),
        ("Galician", "gl"), ("Georgian", "ka"), ("German", "de"), ("Greek", "el"),
        ("Gujarati", "gu"), ("Haitian Creole", "ht"), ("Hebrew", "he"), ("Hindi", "hi"),
        ("Hmong Daw (Latin)", "mww"), ("Hungarian", "hu"), ("Icelandic", "is"),
        ("Indonesian", "id"), ("Inuinnaqtun", "ikt"), ("Inuktitut", "iu"), ("Inuktitut (Latin)", "iu-Latn"),
        ("Irish", "ga"), ("Italian", "it"), ("Japanese", "ja"), ("Kannada", "kn"),
        ("Kazakh", "kk"), ("Khmer", "km"), ("Klingon", "tlh-Latn"), ("Klingon (plqaD)", "tlh-Piqd"),
        ("Korean", "ko"), ("Kurdish (Central)", "ku"), ("Kurdish (Northern)", "kmr"),
        ("Kyrgyz (Cyrillic)", "ky"), ("Lao", "lo"), ("Latvian", "lv"), ("Lithuanian", "lt"),
        ("Macedonian", "mk"), ("Malagasy", "mg"), ("Malay (Latin)", "ms"), ("Malayalam", "ml"),
        ("Maltese", "mt"), ("Maori", "mi"), ("Marathi", "mr"), ("Mongolian (Cyrillic)", "mn-Cyrl"),
        ("Mongolian (Traditional)", "mn-Mong"), ("Myanmar", "my"), ("Nepali", "ne"),
        ("Norwegian", "nb"), ("Odia", "or"), ("Pashto", "ps"), ("Persian", "fa"),
        ("Polish", "pl"), ("Portuguese (Brazil)", "pt"), ("Portuguese (Portugal)", "pt-pt"),
        ("Punjabi", "pa"), ("Queretaro Otomi", "otq"), ("Romanian", "ro"), ("Russian", "ru"),
        ("Samoan (Latin)", "sm"), ("Serbian (Cyrillic)", "sr-Cyrl"), ("Serbian (Latin)", "sr-Latn"),
        ("Slovak", "sk"), ("Slovenian", "sl"), ("Somali (Arabic)", "so"), ("Spanish", "es"),
        ("Swahili (Latin)", "sw"), ("Swedish", "sv"), ("Tahitian", "ty"), ("Tamil", "ta"),
        ("Tatar (Latin)", "tt"), ("Telugu", "te"), ("Thai", "th"), ("Tibetan", "bo"),
        ("Tigrinya", "ti"), ("Tongan", "to"), ("Turkish", "tr"), ("Turkmen (Latin)", "tk"),
        ("Ukrainian", "uk"), ("Upper Sorbian", "hsb"), ("Urdu", "ur"), ("Uyghur (Arabic)", "ug"),
        ("Uzbek (Latin)", "uz"), ("Vietnamese", "vi"), ("Welsh", "cy"), ("Yucatec Maya", "yua"),
        ("Zulu", "zu")
    ]
