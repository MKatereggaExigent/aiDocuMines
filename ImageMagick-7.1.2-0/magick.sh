...
top_srcdir='/app/ImageMagick-7.1.2-0'
top_builddir='/app/ImageMagick-7.1.2-0'

MAGICK_CODER_MODULE_PATH='/app/ImageMagick-7.1.2-0/coders'
MAGICK_CONFIGURE_SRC_PATH='/app/ImageMagick-7.1.2-0/config'
MAGICK_CONFIGURE_BUILD_PATH='/app/ImageMagick-7.1.2-0/config'
MAGICK_FILTER_MODULE_PATH='/app/ImageMagick-7.1.2-0/filters'
DIRSEP=':'
