...
top_srcdir='/app/ImageMagick-7.1.1-47'
top_builddir='/app/ImageMagick-7.1.1-47'

MAGICK_CODER_MODULE_PATH='/app/ImageMagick-7.1.1-47/coders'
MAGICK_CONFIGURE_SRC_PATH='/app/ImageMagick-7.1.1-47/config'
MAGICK_CONFIGURE_BUILD_PATH='/app/ImageMagick-7.1.1-47/config'
MAGICK_FILTER_MODULE_PATH='/app/ImageMagick-7.1.1-47/filters'
DIRSEP=':'
